...
<link rel="stylesheet" href="{{asset('StyleAdmin/plugins/datatables/dataTables.bootstrap.css')}}">
    ...
    <div class="col-xs-12"> 
      ...
      <div class="box box-primary">
       <div class="box-header">
         ...
         <a class="btn  btn-warning fa fa-plus" href="{{route('ajoutEnfant')}}" type="buton" id="new"> NOUVEAU</a>
         <!--   <B>  <h3>Liste des clients  Liste des clients </h3></B> -->
         <B><h3 class="">Liste des enfants</h3></B>
 ...
 <div class="col-md-6">
     <div class="box box-success">
                   <div class="box-header">
                  <h3 class="box-title">{{"Type de liste à voir"}}</h3>
                </div>
                 <div class="box-body">
...
<!-- 
        <table id="example2" class="table table-bordered table-hover display compact cell-border"> 
         <thead>
          <tr>

            <th width="150px">No </th>
            <th style="text-align:center">Nom/Raison sociale</th>
            <th>NIF</th>
            <th  style="text-align:center">Nom</th>
            <th>Téléphone</th>
            <th>Email</th>
