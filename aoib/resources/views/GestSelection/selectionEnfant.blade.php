            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                        ...
                        <div class="col-md-12">
                            <div class="">
                                <div class="box-header" class="col-md-12">
                                    <h3 class="box-title" style="color: #990000;text-align: center">LISTE DES ENFANT NOM PARAINEE</h3>
                                </div>
                                <div class="box-body">
                                    <form method="post" >
                                        {{ csrf_field() }}
                                        ...
                                        <button class="btn  btn-primary fa fa-search" > Rechercher</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="box-body">
                            {{ csrf_field() }}
                            <a href="{{ route('selectionEnfant.show',$i) }}"><button class="btn  btn-primary fa fa-check">Selectionné</button></a>
                        </div>
                    <br>  <br>  <br>  <br>
                </div>
                <!--/box-body -->
