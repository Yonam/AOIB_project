      ...
      <section class="sidebar">
        ...
        <!--   <li class="active"><a href="#"><i class="fa fa-link"></i> <span>Link</span></a></li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="{{route('ajoutEnfant.index')}}"><i class="fa fa-circle-o"></i> Nouvel Enregistrement</a></li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <!-- <li><a href="{{route('ConsultDoc')}}"><i class="fa fa-circle-o"></i> Consulatation de document</a></li> Suivi scolaire -->

              <li><a href="{{route('dataChild')}}"><i class="fa fa-circle-o"></i> Données des enfants</a></li>
              <li><a href="{{route('ConsultDoc')}}"><i class="fa fa-circle-o"></i> Suivi scolaire</a></li> 
          ...
          <li class="treeview">
            <a href="#">
              <i class="fa fa-users fa-fw"></i> <span>Gestion des sélections</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
          ...
          <li class="treeview">
            <a href="#">
              <i class="fa fa-sign-out"></i> <span>Espace Administrateurs </span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li><a href="{{route('droituser.index')}}"><i class="fa fa-circle-o"></i> Gestion des utilisateurs </a></li>
              <!--<li><a href="{{--route('listeSortie')--}}"><i class="fa fa-circle-o"></i> Gestion des enfants </a></li>
              <li><a href="{{--route('listeSortie')--}}"><i class="fa fa-circle-o"></i> Gestion des selections</a></li> -->
              <li><a href="{{route('parrinage.index')}}"><i class="fa fa-circle-o"></i> Gestion des parainages</a></li>
            </ul>
          </li>
